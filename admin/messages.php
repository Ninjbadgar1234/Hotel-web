        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="home.php"><i class="fa fa-dashboard"></i> Админ</a>
                    </li>
                    <li>
                        <a class="active-menu" href="messages.php"><i class="fa fa-desktop"></i>Удирдах</a>
                    </li>
					<!--<li>
			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                           Захиалга<small> Удирдах самбар</small>
                        </h1>
                    </div>
                </div> 
                 <!-- /. ROW  -->
